...
module.exports = {
  ...
  userPrincipalName: process.env.USER_PRINCIPLE_NAME || 'torrents@rifat.website',
  ...
  title: "MrShadowRIFAT's OneDrive",
  ...
  footer:
    'Powered by OneDrive. Sharing is caring — <a href="https://rifat.website" target="_blank" rel="noopener noreferrer">MrShadowRIFAT</a>.',
  ...
  email: 'mailto:contact@rifat.website',
  ...
  links: [
    {
      name: 'GitHub',
      link: 'https://github.com/MrShadowRIFAT',
    },
  ],
